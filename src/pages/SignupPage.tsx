...
const SignupPage = () => {
  return (
    <div className="bg-slate-900 text-slate-100 min-h-screen flex items-center justify-center relative font-sans">
      ...
      <div className="w-full max-w-md mx-auto p-8 rounded-2xl shadow-lg bg-slate-800/60 backdrop-blur-lg border border-slate-700/50">
        <h2 className="text-3xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-violet-500 mb-6">Create your VizPDF account</h2>
        <SignUp routing="path" path="/signup" signInUrl="/login" appearance={{
          elements: {
